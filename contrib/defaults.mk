...
HYPRE_DIR = @MFEM_DIR@/../hypre-2.19.0/src/hypre
...
MKLROOT=/home/luowen/intel/oneapi/mkl/latest/bin/intel64
...
SCALAP = -L$(MKLROOT) -lmkl_scalapack_lp64 -lmkl_blacs_intelmpi_lp64 $(LAPACK)

# MPI Fortran library, needed e.g. by STRUMPACK or MUMPS
# MPICH:
# MPI_FORTRAN_LIB = -lmpifort
MPIIFORT_ROOT=/home/luowen/intel/oneapi/mkl/latest/lib
MPI_FORTRAN_LIB =-L$(MPIIFORT_ROOT) -lmpifort
IFCORE_ROOT=/home/luowen/intel/oneapi/compiler/latest/linux/compiler/lib/intel64
IFCORE_LIB=-L$(IFCORE_ROOT) -lifcore
...
MUMPS_OPT = -I$(MUMPS_DIR)/include
MUMPS_LIB = -L$(MUMPS_DIR)/lib -ldmumps -lmumps_common -lpord $(SCALAP) $(LAPACK) -qopenmp $(MPI_FORTRAN_LIB) $(IFCORE_LIB)
...
MKL_CPARDISO_DIR = /home/luowen/intel/oneapi/mkl/latest/bin/intel64
# MKL_MPI_WRAPPER = mkl_blacs_mpich_lp64
...
# MKL_PARDISO_DIR ?=
# MKL_LIBRARY_SUBDIR ?= lib
MKL_PARDISO_DIR = /home/luowen/intel/oneapi/mkl/latest/bin/intel64
MKL_LIBRARY_SUBDIR = lib
